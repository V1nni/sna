...
userid<-user$data$id
b<-paste(user$data$id,user$data$username,user$data$full_name,user$data$website,user$data$bio,user$data$profile_picture,user$data$counts$media,user$data$counts$followed_by,user$data$counts$follows,sep="','")
